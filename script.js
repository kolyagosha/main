const translations = {
    ua: {
        ...
        ssrm_p: "Динамічна модель для збереження шлюбів. Чекаємо на вердикт Професора.",
    ...
    en: {
        ...
        ssrm_p: "A dynamic model for saving marriages. Awaiting the Professor's verdict.",
